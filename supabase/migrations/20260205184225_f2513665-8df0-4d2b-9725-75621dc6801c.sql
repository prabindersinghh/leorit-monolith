-- Update the order state transition validation function to allow SAMPLE_QC_UPLOADED directly from PAYMENT_CONFIRMED
...
DECLARE
  valid_transitions jsonb := '{
    ...
    "PAYMENT_CONFIRMED": ["SAMPLE_IN_PROGRESS", "SAMPLE_QC_UPLOADED", "BULK_IN_PRODUCTION"],
